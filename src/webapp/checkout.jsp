...
<div class="d-flex">
  ...
  <form action="CheckOutServlet" method="post">
    ...
    <label>
     <input type="radio" name="dbt" value="razorpay"> Razorpay
    </label>
  ...
  <div class="Yorder">
	...
	<tbody>
				...
				<tr>
					<td><img class="card-img-top" src="product-image/<%=c.getImage() %>" width="60px" height="70px"></td>
					<td><%=c.getName()%></td>
					<td><%=c.getQuantity()%></td>
          ...
          <h4 style="margin-left:120px">Total Price: $ ${(total>0)?dcf.format(total):0} </h4>
    <hr>
