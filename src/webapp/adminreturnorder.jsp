...
<body>
    ...
    <ul class="navmenu">
     <h2 style="margin-top:15px; margin-left:40px">All Return Order Item  </h2>
    </ul>
    <div class="nav-icon">
      ...
      <div class="content-wrapper">
                <div class="container-fluid">
                    <div class="row pad-botm">
                        <div class="col-md-12" >
                            <h4 class="header-line" align="center" style="margin-top:50px ">All Return Orders Items Details </h4>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        ...
                                        <%
                                            ResultSet rs = DatabaseConnection.getResultFromSqlQuery("select * from orders o,products p,users u where o.p_id=p.id and o.u_id=u.id and o.status='return'");
                                            while (rs.next()) {
                                        %>
                                        <tbody>
                                         <tr>
                                                ...
                                                <td><%=rs.getString("u.name") %></td>
                                                 ...
                                                 <td><p class="btn  btn-primary text-white">Return</p>
